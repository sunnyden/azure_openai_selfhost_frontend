...
export interface ConversationItem {
    ...
    titleGenerated?: boolean; // Track if title was auto-generated by LLM
}
...
interface ConversationHistoryData {
    ...
    markTitleAsGenerated: (conversationId: string) => void;
}
...
export function ConversationHistoryProvider({
    ...
    const markTitleAsGenerated = useCallback((conversationId: string) => {
        setConversations((prev) =>
            prev.map((conv) =>
