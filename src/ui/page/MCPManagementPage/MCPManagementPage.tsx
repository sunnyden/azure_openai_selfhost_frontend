        ...
        >
          ...
          >
            ...
            <Typography variant="body1" color="text.secondary">
              MCP (Model Context Protocol) features are only available when
              running the application in desktop mode. Please use the desktop
              version of the application to manage MCP servers.
            </Typography>
          </Paper>
        </Container>
      </Box>
    ...
    <Box sx={{ height: "100dvh", display: "flex", flexDirection: "column" }}>
      ...
      <Container maxWidth="lg" sx={{ flex: 1, py: 3, overflow: "auto" }}>
        <Stack spacing={3}>
          ...
          {testSuccess && (
            <Alert severity="success" onClose={() => setTestSuccess(null)}>
              {testSuccess}
            </Alert>
          )}
              ...
              {servers.length === 0 ? (
                ...
                <List>
                  {servers.map(server => {
                    ...
                    const isTestingThisServer = testingServer === server.name;
                      ...
                      <ListItem key={server.name} divider>
                        ...
                        <ListItemSecondaryAction>
                          <IconButton
                            ...
                            disabled={loading || isTestingThisServer}
                            sx={{ mr: 1 }}
